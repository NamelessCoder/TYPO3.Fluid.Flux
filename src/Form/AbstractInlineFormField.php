...
use NamelessCoder\Flux\Form\Field\Inline;
...
abstract class AbstractInlineFormField extends AbstractRelationFormField implements InlineRelationFieldInterface {
	...
	/**
	 * Record link position - can be either \NamelessCoder\Flux\Form::POSITION_TOP,
	 * \NamelessCoder\Flux\Form::POSITION_BOTTOM, \NamelessCoder\Flux\Form::POSITION_BOTH or
	 * \NamelessCoder\Flux\Form::POSITION_NONE.
	 *
	 * @var string
	 */
